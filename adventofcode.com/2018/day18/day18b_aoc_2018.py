...
def solveday18b_aoc_2018_part_1(choseninput) :
    ...
    for ii in range(10000) :
        ...
        print(ii+1,trees*yards,trees*yards-previous)
        previous = trees * yards
    return trees*yards    
    
    
    solve_day18b_aoc_2018_part_1(puzzleinput)
    
    print(1000000000 % 28) # =20
    print(4360 % 28) # =20
    print(190820) # 4360 190820
